...
bool UXRCoreUtilities::IsActorInteractive(AActor* InActor, TArray<UXRInteractionComponent*>& OutActiveXRInteractions)
{
    if (!InActor)
    {
        return false;
...
bool UXRCoreUtilities::IsActorInteractedWith(AActor* InActor, TArray<UXRInteractionComponent*>& OutActiveXRInteractions)
{
    if (!InActor)
    {
        return false;
...
UXRInteractionComponent* UXRCoreUtilities::GetPrioritizedXRInteraction(TArray<UXRInteractionComponent*> InInteractions, UXRInteractorComponent* InXRInteractor,
...
UXRInteractionComponent* UXRCoreUtilities::GetPrioritizedXRInteractionOnActor(AActor* InActor, UXRInteractorComponent* InXRInteractor, bool IgnoreActive, bool SortByLowest)
{
    if (!InActor)
    {
        return nullptr;
